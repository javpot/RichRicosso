...
let dot1Selected = true;


// Obtenez la valeur de l'attribut "src" de l'élément img
const imgSrc = imgElement.getAttribute("src");

// Stockez la valeur de "src" dans la variable imgProduct
...
const dot1Clicked = () => {
    ...
    if (dot1Selected == true) {
        ...
        const newSrc = beforeLastDot + afterLastDot;
